...
void Icons::draw(int x, int y, const char* iconCode) {
    vita2d_font_draw_text(font, x, y, DEFAULT_FONT_COLOR, DEFAULT_FONT_SIZE, iconsReferences[iconCode]);
}

void Icons::draw(int x, int y, const char* iconCode, unsigned int color) {
    vita2d_font_draw_text(font, x, y, color, DEFAULT_FONT_SIZE, iconsReferences[iconCode]);
}

void Icons::draw(int x, int y,const char* iconCode, unsigned int color, unsigned int size) {
    vita2d_font_draw_text(font, x, y, color, size, iconsReferences[iconCode]);
}